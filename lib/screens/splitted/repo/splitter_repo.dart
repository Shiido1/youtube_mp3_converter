...
class SplitterRepo {
  Future<ApiResponse<Splitter>> split(String map) async {
    try {
      final response =
          await jayNetworkClient.makePostRequest("splitter?", data: map);
      return ApiResponse.success(data: Splitter.fromJson(response.data));
    } catch (e) {
