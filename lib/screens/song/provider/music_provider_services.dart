...
//
// _entryPoint()=> AudioServiceBackground.run(() => MusicProvider());
//
//
// class MusicProvider extends BackgroundAudioTask with ChangeNotifier {
...
//     );
//     await advancedPlayer.play(currentSong.file);
//
//     AudioServiceBackground.setState(
//         controls: [MediaControl.pause, MediaControl.stop],
//         playing: true,
