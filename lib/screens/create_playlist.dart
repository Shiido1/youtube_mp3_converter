...
import 'package:mp3_music_converter/utils/helper/config.dart';
...
class _CreatePlayListState extends State<CreatePlayList> {
  ...
  void createPlaylist() {
    if (inputFeild.text != '') {
      ...
      final playlistDB = Provider.of<MusicProvider>(context, listen: false);
      playlistDB.createPlaylist(playlistName);
      showToast(context, message: "Created Successfully");
      inputFeild.clear();
